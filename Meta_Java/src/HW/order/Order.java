...
//	private List<Item> items;
	...
	public Order(String orderNum, int orderSize, Member member, Item item) {
		super();
		this.orderNum = orderNum;
		this.orderSize = orderSize;
		this.member = member;
		this.item = item;
		this.orderPrice = item.getItemPrice()*orderSize;
	}
	...
	public void show() {
		...
		System.out.println("주문수량 :"+orderSize+"개");
